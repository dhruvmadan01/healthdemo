...
-- 1b. Add new columns to existing profiles table if they do not exist
...
values
('d1', 'Dr. Elizabeth Vance', 'MD, FACC - Harvard Medical School', 'Cardiology', 14, 'h1', '{"rating": 4.9, "count": 245}', 1500, array['In-person', 'Online'], array['English', 'Hindi'], array['Aetna', 'Blue Cross', 'Cigna', 'UnitedHealth'], array['09:00 - 12:00', '14:00 - 17:00'], array['Top Cardiologist Metro Area 2024', 'AMA Research Award'], 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=300', 'elizabeth.vance@oneminute.com', '+1-555-0190', 'approved'),
('d2', 'Dr. Marcus Vance', 'MD, FAAP - Johns Hopkins University', 'Pediatrics', 10, 'h2', '{"rating": 4.7, "count": 189}', 1000, array['In-person', 'Online'], array['English'], array['Blue Cross', 'Cigna', 'Medicaid'], array['08:30 - 11:30', '13:00 - 16:30'], array['Compassionate Care Award 2025'], 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=300', 'marcus.vance@oneminute.com', '+1-555-0191', 'approved'),
('d3', 'Dr. Sarah Lin', 'MD, D.D.V - Stanford School of Medicine', 'Dermatology', 8, 'h2', '{"rating": 4.8, "count": 312}', 1200, array['In-person', 'Online'], array['Hindi'], array['Aetna', 'UnitedHealth', 'Humana'], array['10:00 - 13:00', '15:00 - 18:00'], array['Young Investigator Fellowship 2023'], 'https://images.unsplash.com/photo-1594824813573-246434de83fb?auto=format&fit=crop&q=80&w=300', 'sarah.lin@oneminute.com', '+1-555-0192', 'approved'),
('d4', 'Dr. Jonathan Reyes', 'MD, PhD - Yale School of Medicine', 'Neurology', 18, 'h1', '{"rating": 4.9, "count": 420}', 2000, array['In-person'], array['English', 'Hindi'], array['Aetna', 'Blue Cross', 'Medicare'], array['09:00 - 13:00'], array['National Neurological Society Lifetime Fellow'], 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&q=80&w=300', 'jonathan.reyes@oneminute.com', '+1-555-0193', 'approved'),
('d5', 'Dr. Clara Oswald', 'MD - London School of Medicine', 'General Medicine', 12, 'h2', '{"rating": 4.8, "count": 140}', 900, array['In-person', 'Online'], array['English'], array['Aetna', 'Blue Cross', 'Cigna'], array['10:00 - 13:00', '14:00 - 16:00'], array['Excellence in Primary Care'], 'https://images.unsplash.com/photo-1594824813573-246434de83fb?auto=format&fit=crop&q=80&w=300', 'clara.oswald@oneminute.com', '+1-555-0194', 'approved'),
('d6', 'Dr. Raj Patel', 'MS (Ortho) - AIIMS Delhi', 'Orthopedics', 15, 'h1', '{"rating": 4.9, "count": 210}', 1400, array['In-person'], array['English', 'Hindi'], array['Blue Cross', 'Cigna', 'UnitedHealth'], array['09:00 - 12:00', '15:00 - 18:00'], array['Best Orthopedic Surgeon 2024'], 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=300', 'raj.patel@oneminute.com', '+1-555-0195', 'approved'),
('d7', 'Dr. Elena Rostova', 'MD, PhD - Saint Petersburg State University', 'Cardiology', 20, 'h3', '{"rating": 5.0, "count": 95}', 1800, array['In-person', 'Online'], array['English'], array['Aetna', 'Blue Cross', 'UnitedHealth'], array['11:00 - 14:00'], array['Global Cardiology Fellowship Recipient'], 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=300', 'elena.rostova@oneminute.com', '+1-555-0196', 'approved')
on conflict (id) do update set
...
begin
    ...
    insert into public.profiles (
        ...
        coalesce((new.raw_user_meta_data->'emergency_contact'), '{"name": "", "relation": "", "phone": ""}'::jsonb),
        coalesce((new.raw_user_meta_data->'settings'), '{"language": "English", "organDonor": false, "darkMode": false, "biometricsEnabled": false}'::jsonb),
        coalesce((new.raw_user_meta_data->'medical_history'), '{"allergies": [], "chronicDiseases": [], "surgeries": [], "currentMedicines": []}'::jsonb),
        coalesce((new.raw_user_meta_data->'lifestyle'), '{"smoking": "Never", "alcohol": "Never", "exercise": "None", "sleep": "8 hours"}'::jsonb),
        80
    );
    return new;
end;
